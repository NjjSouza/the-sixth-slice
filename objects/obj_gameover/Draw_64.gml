...
draw_text(
    cx - string_width("SCORE: " + string(score_final))/2 + sx,
    320 + sy,
    "SCORE: " + string(score_final)
);

draw_set_color(make_color_rgb(180,220,255));
draw_text(
    cx - string_width("TEMPO: " + string(minutos) + ":" + seg_str)/2 + sx,
    350 + sy,
    "TEMPO: " + string(minutos) + ":" + seg_str
);
...
draw_set_color(make_color_rgb(180,220,255));
draw_text(
    cx - string_width("PRESSIONE R PARA REINICIAR")/2 + sx,
    430 + sy,
